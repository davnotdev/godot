...
add_library(dawn::webgpu_dawn STATIC IMPORTED)

set_target_properties(dawn::webgpu_dawn PROPERTIES
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:\$<\$<BOOL:/usr/lib/librt.a>:-lrt>>;\$<LINK_ONLY:\$<\$<BOOL:>:-ladvapi32>>;\$<LINK_ONLY:\$<\$<PLATFORM_ID:Darwin,iOS,tvOS,visionOS,watchOS>:-Wl,-framework,CoreFoundation>>;\$<LINK_ONLY:\$<\$<BOOL:EXECINFO_LIBRARY-NOTFOUND>:EXECINFO_LIBRARY-NOTFOUND>>;\$<LINK_ONLY:\$<\$<BOOL:>:-ldbghelp>>;\$<LINK_ONLY:dl>;\$<LINK_ONLY:rt>;dawn::dawn_public_config;\$<LINK_ONLY:Threads::Threads>;\$<LINK_ONLY:dl>"
)
